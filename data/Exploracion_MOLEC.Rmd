...
output_path <- file.path(output_dir, "nuevote_molec_light_2019_2021_2023.csv")
...
El archivo `data/nuevo_molec_light_2019_2021_2023.csv` contiene las tres bases con las variables de interés y los valores `0` convertidos a `NA`.
