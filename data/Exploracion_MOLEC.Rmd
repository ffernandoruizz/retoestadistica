...
```{r}
vars_cero <- c("p4", "p5", "p6_1", "p6_2", "p6_3", "p6_4", "p6_5", "p6_6", "p26", "p32")
vars_no_recuerda <- c("p34_1", "p34_2", "p34_3", "p34_4", "p36_1", "p36_2", "p36_3", "p36_4")
...
output_path <- file.path(output_dir, "molec_light_2019_2021_2023.csv")
